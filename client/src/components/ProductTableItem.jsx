...
const ProductTableItem = ({ product }) => {
  ...
  const onSaveProduct = () => {
    dispatch(
      updateProduct(brand, name, category, stock, price, product._id, productIsNew, description, subtitle, stripeId, imageOne, imageTwo)
    );
  };
        ...
        <Td>
          <VStack>
            ...
            <Button colorScheme="green" w="160px" variant="outline" onClick={onSaveProduct}>
              <MdOutlineDataSaverOn style={{ marginRight: "7px" }} />
              Save Changes
            </Button>
          </VStack>
        </Td>
